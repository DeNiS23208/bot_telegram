...
# Уведомление за 5 минут до истечения (5 минут = 5/1440 дней)
SUBSCRIPTION_EXPIRING_NOTIFICATION_DAYS = 5 / 1440  # За сколько дней уведомлять об истечении (5 минут)
...
dni_prazdnika = 30  # Длительность бонусной недели в минутах (30 минут)
vremya_sms = 5  # Время уведомления до окончания в минутах (5 минут)
...
PRODUCTION_PRICE_RUB = "1.00"  # Обычная цена подписки (1 рубль)
PRODUCTION_DURATION_DAYS = 30 / 1440  # Обычная длительность подписки (30 минут)

# Автопродление
AUTO_RENEWAL_ATTEMPT_INTERVAL_MINUTES = 1  # Интервал между попытками автопродления (1 минута)
