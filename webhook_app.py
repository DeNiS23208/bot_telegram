...
async def payment_return(request: Request):
    ...
    МГНОВЕННО отправляет уведомление и редиректит в бота
    """
    print(f"🔄 Получен запрос на /payment/return: {request.url}")
    ...
    if payment_id:
        try:
            ...
            if tg_user_id:
                ...
                # МГНОВЕННО отправляем уведомление о выходе из оплаты
