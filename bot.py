...
async def pay(message: Message):
    ...
    # Используем обычный текст вместо ссылок, чтобы избежать превью документа от Яндекс Диска
    subscription_text = (
        ...
        "📄 Документы:\n"
        "• Персональные данные: https://disk.yandex.ru/i/QadGJAMYKqbKpQ\n"
        "• Публичная оферта: https://disk.yandex.ru/i/fXUDJfj_i5cYIA\n\n"
